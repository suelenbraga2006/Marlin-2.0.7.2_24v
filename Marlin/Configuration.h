...
#define STRING_CONFIG_H_AUTHOR "Suelen, SKR 1.3 Hypercube" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  17.20
    #define DEFAULT_Ki   1.15
    #define DEFAULT_Kd  64.23
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 232.82
  #define DEFAULT_bedKi  46.52
  #define DEFAULT_bedKd 776.85
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26, 9, 0 }
